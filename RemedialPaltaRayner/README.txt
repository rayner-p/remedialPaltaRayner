...
a persistence unit "RemedialPaltaRaynerPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "RemedialPaltaRayner\pom.xml":
...
artifact ("RemedialPaltaRayner.war") is already built. You can build
